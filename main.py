...
def launch_game(): #LANCEMENT DU PROGRAMME PRINCIPALE
    ...
    def make_dice(): #FONCTION POUR CREER LES DES
        global remove_dice, nb_de1, nb_de2, state_launch, nb_shot, nb_faces
        nb_de1, nb_de2 = randint(1,nb_faces), randint(1,nb_faces)
